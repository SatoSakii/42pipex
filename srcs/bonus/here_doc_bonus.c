...
void	here_doc_child(int pipefd[2], int file[2], t_data *data)
{
	char	*line;
	char	*buf;
	size_t	len;
...
void	here_doc_setup(t_data *data, int *pipefd, int file[2])
{
...
void	here_doc_pipeline(int start, t_data *data, int file[2], int pipefd[2])
{
...
void	here_doc(int start, t_data *data)
{
	int	pipefd[2];
	int	file[2];
